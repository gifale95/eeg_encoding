...
(Y) and feature maps (X), and the learned weights are used to predict the EEG
...
import argparse
from predicting_data_utils import load_dnn_data
from predicting_data_utils import load_eeg_data
from predicting_data_utils import perform_regression
